...
@section('title', 'Edit Attribute - EktaMart Admin')
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h4 class="fw-bold mb-0">
                <i class="fas fa-edit text-warning me-2"></i>Edit Attribute
            </h4>
            <p class="text-muted small">Update attribute information</p>
        </div>
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" 
                                   placeholder="e.g. Size, Color, Material" value="{{ old('name', $attribute->name) }}" required>
                            @error('name')
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" 
                                   placeholder="auto-generated from name" value="{{ old('slug', $attribute->slug) }}">
...
<script>
    console.log('%c✏️ Edit Attribute Page Loaded', 'color: #f59e0b; font-size: 13px; font-weight: bold;');
</script>
@endsection